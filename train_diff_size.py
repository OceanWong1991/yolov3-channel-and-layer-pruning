...
def train():
    ...
    model = Darknet(cfg, (384, 540), arc=opt.arc).to(device)
    if t_cfg:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--accumulate', type=int, default=2,
                        help='batches to accumulate before optimizing')  # 500200*16*4/117263 = 273
    parser.add_argument('--cfg', type=str, default='/home/ai/data2/xzwang/T7_Train/cfg/yolov4-tiny_t7_v4.0.cfg',
                        help='cfg file path')
    parser.add_argument('--data', type=str, default='/home/ai/data2/xzwang/T7_Train/cfg/t7_pd_v4.1.data',
                        help='*.data file path')
    parser.add_argument('--weights', type=str,
                        default='/home/ai/DeepGit/yolov3-channel-and-layer-pruning/weights/backup450.pt',
                        help='initial weights')  # i.e. weights/darknet.53.conv.74
    parser.add_argument('--img_size', type=int, default=540, help='inference size (pixels)')
    parser.add_argument('--rect', action='store_false', help='rectangular training')

    # TODO PRUNE
    # parser.add_argument('--sparsity-regularization', '-sr', dest='sr', action='store_false', help='train with channel sparsity regularization')
