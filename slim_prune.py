...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/ai/DeepGit/yolov3-channel-and-layer-pruning/v4.2/prune_0.3_keep_0.01_.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='/home/ai/DeepGit/darknet/cfg/t7_yolov4_pd.data', help='*.data file path')
    parser.add_argument('--weights', type=str, default='weights/last.pt', help='sparse model weights')
    parser.add_argument('--global_percent', type=float, default=0.36, help='global channel prune percent')
